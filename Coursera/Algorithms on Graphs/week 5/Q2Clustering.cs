...
namespace A4 {
    public class Q2Clustering {
        static void Main(string[] args) {
            ...
            Console.WriteLine(Solve(v, points, long.Parse(Console.ReadLine())));
        }
        public static double Solve(long pointCount, long[][] points, long clusterCount) {
            return prim(pointCount, points, clusterCount);
        }

        private static double prim(long pointCount, long[][] points, long clusterCount) {
            ...
            PriorityQueue<long> treeEdges = new PriorityQueue<long>();
