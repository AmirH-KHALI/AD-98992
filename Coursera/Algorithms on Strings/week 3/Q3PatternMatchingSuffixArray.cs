...
namespace A7 {
    public class Q3PatternMatchingSuffixArray {
        ...
        private static long[] buildLCP(string txt, long[] order) {
            int n = txt.Length;
            long[] lcp = new long[n];
        ...
        private static void find(string text, long[] order, string pattern,
        ...
        private static bool isSub(string pattern, string text, long pos) {
        ...
        public static long[] getSuffixArray(string text) {
